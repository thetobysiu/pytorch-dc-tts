...
Speech.load(['mags', 'mels'], args.voice, args.script)

train_data_loader = SSRNDataLoader(Speech, batch_size=hp.ssrn_batch_size, mode='train')
valid_data_loader = SSRNDataLoader(Speech, batch_size=hp.ssrn_batch_size, mode='valid')
